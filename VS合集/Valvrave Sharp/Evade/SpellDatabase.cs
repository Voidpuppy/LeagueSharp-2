namespace Valvrave_Sharp.Evade
{
    ...
    public static class SpellDatabase
    {
        ...
        static SpellDatabase()
        {
			...
			Spells.Add(
				new SpellData {
					ChampionName = "Taric",SpellName = "TaricQ",Slot = SpellSlot.Q,
					Type = SkillShotType.SkillshotMissileLine,Delay = 250,Range = 900,Radius = 200,MissileSpeed = 1400,
					AddHitbox = true,DangerValue = 3,MissileSpellName = "TaricQMissile",
					CollisionObjects = new[] { CollisionObjectTypes.YasuoWall }
				});
			#endregion
